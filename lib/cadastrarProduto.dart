...
class cadastrarProduto extends StatefulWidget {
  ...
  @override
  State<cadastrarProduto> createState() => cadastrarProdutoState();
}

class cadastrarProdutoState extends State<cadastrarProduto> {
                  ...
                  SizedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // Texto "Cadastre um novo produto"
                        Text(
                            ...
                            child: MouseRegion(
                              ...
                              child: TextButton(
                                onPressed: () {
                                  ...
                                  // Ordenando a listaDeProdutos por descrição em ordem alfabética
