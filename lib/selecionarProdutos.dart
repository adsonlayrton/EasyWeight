...
class selecionarProduto extends StatefulWidget {
  const selecionarProduto({super.key});
  @override
  State<selecionarProduto> createState() => selecionarProdutoState();
}

class selecionarProdutoState extends State<selecionarProduto> {
                      ...
                      children: [
                        ...
                        Column(
                          children: [
                            ...
                            Padding(
                              padding:
                                  EdgeInsets.symmetric(vertical: 200 * fem),
                              child: SizedBox(
                                width: 352.02 * fem,
                                height: 54.97 * fem,
                                child: MouseRegion(
